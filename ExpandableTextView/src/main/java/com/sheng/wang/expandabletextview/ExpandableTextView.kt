package com.sheng.wang.expandabletextview
...
class ExpandableTextView : LinearLayout, View.OnClickListener {
    ...
    override fun onClick(view: View) {
        ...
        val animation: Animation = if (mCollapsed) {
            ...
            ExpandCollapseAnimation(
                this, height, height + mTextHeightWithMaxLines - mTv!!.height
            )
        }
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (mCollapsedString == null) {
            mCollapsedString = context.getString(R.string.to_shrink_hint)
        }
        typedArray.recycle()
    }
